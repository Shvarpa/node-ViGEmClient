...
const DS4Notification_1 = require("../Common/DS4Notification");
...
class DS4Controller extends ViGEmTarget_1.ViGEmTarget {
    ...
    update() {
        this.checkConnection();
        return Common_1.handlePossibleError(Client_1.vigemclient.vigem_target_ds4_update(this.client.handle, this.target, this.report.freeze()));
    }
}
