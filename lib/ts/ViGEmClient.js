...
const X360Controller_1 = require("./X360Controller");
const DS4Controller_1 = require("./DS4Controller");
class ViGEmClient {
    constructor() {
    ...
    connect() {
        ...
        let error = Common_1.handlePossibleError(Client_1.vigemclient.vigem_connect(this._handle));
